// Fast System Kernel - Advanced Host Controller Interface
// Author: Mario Freire
// Version 0.1
...
extern unsigned long ahci_hba_address;
extern ahci_hba_port_t *ahci_port;
extern ahci_hba_memory_t *ahci_hba;
...
extern int check_ahci_port(int portno);
extern int check_ahci_ports(unsigned char *ports, unsigned char *portmax);
...
extern ahci_hba_memory_t *get_ahci_hba_memory(void);
extern void *get_ahci_hba_ptr(void);
extern unsigned long get_ahci_hba(void);

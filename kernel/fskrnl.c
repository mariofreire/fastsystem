...
ehci_qh_t ehci_async_head __attribute__((aligned(32)));
ehci_qh_t ehci_control_qh __attribute__((aligned(32)));
ehci_qtd_t ehci_qtd_setup __attribute__((aligned(32)));
ehci_qtd_t ehci_qtd_data __attribute__((aligned(32)));
ehci_qtd_t ehci_qtd_status __attribute__((aligned(32)));
usb_setup_t ehci_setup_packet __attribute__((aligned(16)));

unsigned char *usb_ehci_ptr  = (unsigned char *)USB_EHCI_ADDRESS;
usb_ehci_t *usb_ehci;
volatile unsigned long ehci_base = 0;
volatile unsigned long ehci_op = 0;
unsigned char ehci_ports = 0;
unsigned char ehci_available_ports = 0;
unsigned char ehci_available_port[15];

volatile usb_ehci_cap_t *ehci_cap;
volatile usb_ehci_op_regs_t *ehci_op_regs;

int ehci_initialized = 0;

usb_device_t usb_device[MAX_USB_DEVICES];
...
#define pthread_join_function(...) \
    PTHREAD_JOIN_SELECT(__VA_ARGS__, pthread_join2, pthread_join1)(__VA_ARGS__)


void* memcpy(void *s1, const void *s2, size_t n);
void* memset(void *s, int c, size_t n);

int sprintk(char *buf, const char *msg, ...);
...
void sys_exit_group(unsigned long status);
...
void setgdt_entries(void)
{
	...
	setgdt(5, 0x00000000, 0x00000000, 0x89, 0x00); // tss
	//setgdt(5, 0x00000000, 0x00000000, 0xE9, 0x00); // tss
...
void loadgdt(void)
{
	memset(gdt.entry, 0, sizeof(gdt.entry));
	setgdt_entries();
...
void settss_entries(void)
{
	...
	//settss(5, KERNEL_MODE_DATA_SEGMENT, (unsigned long)kstack_top);
...
void loadisr(void)
{
    setidt(0, (unsigned long)isr0, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(1, (unsigned long)isr1, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(2, (unsigned long)isr2, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(3, (unsigned long)isr3, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(4, (unsigned long)isr4, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(5, (unsigned long)isr5, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(6, (unsigned long)isr6, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(7, (unsigned long)isr7, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(8, (unsigned long)isr8, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(9, (unsigned long)isr9, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(10, (unsigned long)isr10, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(11, (unsigned long)isr11, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(12, (unsigned long)isr12, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(13, (unsigned long)isr13, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(14, (unsigned long)isr14, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(15, (unsigned long)isr15, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(16, (unsigned long)isr16, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(17, (unsigned long)isr17, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(18, (unsigned long)isr18, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(19, (unsigned long)isr19, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(20, (unsigned long)isr20, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(21, (unsigned long)isr21, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(22, (unsigned long)isr22, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(23, (unsigned long)isr23, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(24, (unsigned long)isr24, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(25, (unsigned long)isr25, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(26, (unsigned long)isr26, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(27, (unsigned long)isr27, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(28, (unsigned long)isr28, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(29, (unsigned long)isr29, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(30, (unsigned long)isr30, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(31, (unsigned long)isr31, KERNEL_MODE_CODE_SEGMENT, 0x8E);
    setidt(65, (unsigned long)isr65, KERNEL_MODE_CODE_SEGMENT, 0x8E); //0xEE);
    setidt(79, (unsigned long)isr79, KERNEL_MODE_CODE_SEGMENT, 0x8E); //0xEE);
    setidt(106, (unsigned long)isr106, KERNEL_MODE_CODE_SEGMENT, 0x8E); //0xEE);
    setidt(128, (unsigned long)isr128, KERNEL_MODE_CODE_SEGMENT, 0x8E); //0xEE);
}

/*
void loadisr_user(void)
{
    setidt(0, (unsigned long)isr0, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(1, (unsigned long)isr1, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(2, (unsigned long)isr2, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(3, (unsigned long)isr3, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(4, (unsigned long)isr4, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(5, (unsigned long)isr5, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(6, (unsigned long)isr6, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(7, (unsigned long)isr7, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(8, (unsigned long)isr8, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(9, (unsigned long)isr9, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(10, (unsigned long)isr10, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(11, (unsigned long)isr11, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(12, (unsigned long)isr12, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(13, (unsigned long)isr13, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(14, (unsigned long)isr14, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(15, (unsigned long)isr15, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(16, (unsigned long)isr16, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(17, (unsigned long)isr17, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(18, (unsigned long)isr18, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(19, (unsigned long)isr19, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(20, (unsigned long)isr20, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(21, (unsigned long)isr21, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(22, (unsigned long)isr22, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(23, (unsigned long)isr23, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(24, (unsigned long)isr24, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(25, (unsigned long)isr25, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(26, (unsigned long)isr26, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(27, (unsigned long)isr27, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(28, (unsigned long)isr28, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(29, (unsigned long)isr29, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(30, (unsigned long)isr30, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(31, (unsigned long)isr31, USER_MODE_CODE_SEGMENT, 0x8E);
    setidt(65, (unsigned long)isr65, USER_MODE_CODE_SEGMENT, 0xEE);
    setidt(79, (unsigned long)isr79, USER_MODE_CODE_SEGMENT, 0xEE);
    setidt(106, (unsigned long)isr106, USER_MODE_CODE_SEGMENT, 0xEE);
    setidt(128, (unsigned long)isr128, USER_MODE_CODE_SEGMENT, 0xEE);
}
*/
...
unsigned long irq_save_disable(void)
{
    unsigned long flags;
	//if (usermode) return flags;
    __asm__ volatile (
        "pushfl\n\t"
        "popl %0\n\t"
        "cli"
...
void test_irq_safe_critical_section(void)
{
    unsigned long flags;
...
void set_task_priority(int task_id, int priority)
{
    ...
    thread[task_id].priority = priority;

    if (thread[task_id].state == TASK_RUNNING)
    {
        if (thread[task_id].quantum_left <= 0)
            thread[task_id].quantum_left =
...
void task_ready(int task_id)
{
    ...
    {
        thread[task_id].state = TASK_READY;

        if (thread[task_id].quantum_left <= 0)
        {
            thread[task_id].quantum_left =
                (thread[task_id].priority > 0)
                ? thread[task_id].priority
                : 1;
        }
    }
...
void task_block(int task_id)
{
    ...
    if (task_id == idle_thread_id)
        return;

    flags = irq_save_disable();

    thread[task_id].state = TASK_BLOCK;
    thread[task_id].quantum_left = 0;

    irq_restore(flags);
    
    if (task_id == current_thread)
    {
...
void task_msleep(int task_id, unsigned long milliseconds)
{
    unsigned long flags;
    unsigned long delta;
    ...
    if (timer_frequency != 0 &&
        milliseconds > (0xFFFFFFFFU / timer_frequency))
    {
        delta = 0xFFFFFFFFU;
    }
    else
    {
        delta = ((timer_frequency * milliseconds) / 1000);
    }

    flags = irq_save_disable();

    thread[task_id].wake_tick = timertick + delta;
    thread[task_id].state = TASK_SLEEP;
    thread[task_id].quantum_left = 0;
...
void task_sleep(int task_id, unsigned long seconds)
{
    unsigned long flags;
    unsigned long delta;
    ...
    if (timer_frequency != 0 &&
        seconds > (0xFFFFFFFFU / timer_frequency))
    {
        delta = 0xFFFFFFFFU;
    }
    else
    {
        delta = seconds * timer_frequency;
    }
...
void task_terminate(int task_id)
{
    ...
    if (thread[task_id].pid != -1)
    {
    	...
    	if (valid_task_id(_pid))
    	{
    		if (thread[_pid].state != TASK_TERMINATE)
    		{
    			thread[task_id].pid = -1;
    			if (_pid < thread_count) task_terminate(_pid);
    			if (thread[task_id].state == TASK_TERMINATE)
        			return;
        	}
        }
    ...
    thread[task_id].state = TASK_TERMINATE;
    thread[task_id].quantum_left = 0;
    ...
    if (thread[task_id].brk) free(thread[task_id].brk);

    joiner = thread[task_id].joiner_id;

    if (joiner >= 0 &&
        joiner < thread_count &&
        thread[joiner].state == TASK_BLOCK)
    {
        thread[joiner].state = TASK_READY;

        if (thread[joiner].quantum_left <= 0)
        {
            thread[joiner].quantum_left =
                (thread[joiner].priority > 0)
                ? thread[joiner].priority
                : 1;
        }
    }    
...
void task_terminate_with_result(int task_id, void *result)
{
    uint32_t flags;
    int joiner;
    ...
    if (thread[task_id].pid != -1)
    {
    	...
    	if (valid_task_id(_pid))
    	{
    		...
    		{
    			thread[task_id].pid = -1;
    			if (_pid < thread_count) task_terminate_with_result(_pid, result);
    			if (thread[task_id].state == TASK_TERMINATE)
        			return;
        	}
        }
...
void pthread_exit(void *result)
{
    ...
    thread[id].state = TASK_TERMINATE;
    thread[id].quantum_left = 0;

    joiner = thread[id].joiner_id;
...
int pthread_join2(int thread_id, void **result)
{
    int self;
    uint32_t flags;
    ...
    if (thread_id == self)
        return PTHREAD_JOIN_DEADLOCK;

    flags = irq_save_disable();

    if (thread[thread_id].joined)
    {
        irq_restore(flags);
        return PTHREAD_JOIN_ALREADY;
    }

    if (thread[thread_id].state == TASK_TERMINATE)
    {
        if (result != NULL)
            *result = thread[thread_id].result;

        thread[thread_id].joined = TRUE;

        irq_restore(flags);
        return PTHREAD_JOIN_SUCCESS;
    }

    if (thread[thread_id].joiner_id >= 0)
    {
        irq_restore(flags);
        return PTHREAD_JOIN_NO_JOINER;
    }

    thread[thread_id].joiner_id = self;
...
int pthread_join1(int thread_id)
{
    return pthread_join2(thread_id, NULL);
}

int pthread_join(int thread_id, void **result)
{
	return pthread_join_function(thread_id, result);
}
...
void get_thread_list(unsigned long *thread_list, int *thread_list_count)
{
	int t_cnt_a=0,i=0;
	int last_thread_id = -1;
	for(int i1=0;i1<thread_count;i1++)
	{
		if (thread[i1].state != TASK_TERMINATE)
		{
			if (last_thread_id != thread[i1].thread_id)
			{
				t_cnt_a++;
				last_thread_id = thread[i1].thread_id;
			}
		}
	}
	last_thread_id = -1;
	*thread_list_count = t_cnt_a;
	for(int i2=0;i2<thread_count;i2++)
	{
		if (thread[i2].state != TASK_TERMINATE)
		{
			if (last_thread_id != thread[i2].thread_id)
			{
...
void get_thread_list(unsigned long **thread_list, int *thread_list_count)
{
	...
	*thread_list_count = t_cnt_a;
	*thread_list = (unsigned long*)malloc(t_cnt_a*sizeof(unsigned long));
	for(int i2=0;i2<thread_count;i2++)
	{
		if (thread[i2].state != TASK_TERMINATE)
		{
	...
	for(int j=0;j<t_cnt_a;j++) printk("%d: %s\n", *thread_list[j], thread[*thread_list[j]].name);
}

void free_thread_list(unsigned long *thread_list)
{
	if (thread_list) free(thread_list);
}
*/
...
const char *priority_to_string(int priority)
{
    switch (priority) {
        ...
        case PRIORITY_DRIVER:
            return "PRIORITY_DRIVER";
...
{
	int task_scheduler_tick_on;
	if (scheduler_initialized == 1)
	{
    	if (current_thread == idle_thread_id) task_scheduler_tick_on = 0;
    	else task_scheduler_tick_on = 1;
	}
	else
	{
		task_scheduler_tick_on = 0;
    }
	if (task_scheduler_tick_on == 1)
    {
    	task_sleep(current_thread, seconds);
    }
    else
    {
		unsigned long ms;
...
void msleep(unsigned int milliseconds)
{
	...
	if (task_scheduler_tick_on == 1)
	{
		task_msleep(current_thread, milliseconds);
	}
	else
	{
		unsigned long ms;
...
int tick_reached(unsigned long now, unsigned long deadline)
{
    return ((long int)(now - deadline) >= 0);
}
...
void scheduler_tick(void)
{
    ...
    for (i = 0; i < thread_count; i++)
    {
        ...
        if (thread[i].state == TASK_SLEEP &&
            tick_reached(timertick, thread[i].wake_tick))
        {
            thread[i].state = TASK_READY;
            thread[i].quantum_left =
                (thread[i].priority > 0)
                ? thread[i].priority
                : 1;
        }
...
void save_context(context_t *frame)
{
    if (frame == NULL)
        return;
...
context_t *schedule(context_t *current_frame)
{
    ...
    */
        ...
        if (next >= 0 && next < thread_count)
        {
            ...
            next_task->quantum_left =
                next_task->priority > 0
                    ? next_task->priority
                    : 1;
            unsigned long next_cs = ((usermode) ? 
                ((current_thread == 0) 
                    ? next_task->kernel_cs 
                    : next_task->user_cs) 
                    : next_task->kernel_cs);
            unsigned long next_ds = ((usermode) ? 
                ((current_thread == 0) 
                    ? next_task->kernel_ds 
                    : next_task->user_ds) 
                    : next_task->kernel_ds);
    ...
    if (idle_thread_id >= 0)
    {
        ...
        settss_stack(thread[idle_thread_id].kernel_ds, (unsigned long)thread[idle_thread_id].stack_top);
...
volatile unsigned long long counting1 = 0;
volatile unsigned long long counting2 = 0;
volatile unsigned long long counting3 = 0;
volatile unsigned long long counting4 = 0;
...
int execv_file(const char *path, char *const argv[]);

int execvThread(void *param)
{
	const char **argp = (const char **)param;
	argparam_t *args = (argparam_t*)argp;
	if (param == NULL) return -1;
	int is_fn_exec=0;
	thread[current_thread].args = (void*)param;
	//printk("%d: %s\n", current_thread, args->argv[0]);
	is_fn_exec = execv_file((const char*)args->argv[0], (char *const *)args->argv);
	return is_fn_exec;
}

int getargs(argparam_t *args, const char *path, char *const argv[])
{
	int i=0;
	int argc=0;
	char tmp_argv[256];	
	...
	args->argc = 0;
	memset(&args->argv[0], 0, 256*256);
	memset(&args->argv[0][0], 0, 256*256);	
	if ((argv == NULL) || (&argv[0] == NULL))
	{
		...
		if (argc > 0)
		{
			for(int argcount=0;argcount<argc;argcount++)
			{
				...
				getargv(tmp_argv, path, argcount);
				strcpy(args->argv[argcount], tmp_argv);
			}
		}
	}
	else
	{
		for(i=0;i<256;i++)
		{
			if (&argv[i][0] != 0) args->argc++;
		}
		memcpy(&args->argv[0][0], &argv[0], args->argc*256);
		for(int j=0;j<32;j++)
		{
			for(i=0;i<args->argc;i++)
			{
				if (args->argv[i][0] == 0) args->argc--;
			}
		}
		if (args->argc < 0) args->argc = 0;
		if (args->argc > 255) args->argc = 255;
	}
	
	return 0;
}

int execv_1(const char *path, char *const argv[])
{
	int i=0;
	argparam_t args;
	void *result;
	...
	int new_exit_code;
	char exec_fn[256];
	char exec_fn_bin[256];
	char exec_fn_elf[256];
	strcpy(exec_fn, path);
	strcpy(exec_fn_bin, path);
	strcpy(exec_fn_elf, path);
	strcat(exec_fn_bin, ".bin");
	strcat(exec_fn_elf, ".elf");
	if (!fileexists(exec_fn))
	{
		if (!fileexists(exec_fn_bin))
		{
			if (!fileexists(exec_fn_elf)) return WEXITSTATUS_NOT_FOUND;
		}
	}
	if (!scheduler_initialized) return execv_file(path, argv);
...
void system(char *filename)
{
	...
	if (argc > 0)
	{
		...
		{
			memset(tmp_argv, 0, 256);
			getargv(tmp_argv, filename, argcount);
...
{
    if (current_thread < 0 || current_thread >= thread_count)
        return;
        
    task_t *t = (task_t*)&thread[current_thread];
    context_t *ctx = &t->context;

    printk("Task %d\n", current_thread);
    printk("  task      = 0x%08x\n", (unsigned long)&thread[current_thread]);
    printk("  esp       = 0x%08x\n", (unsigned long)thread[current_thread].esp);
    ...
    printk("  FS        = 0x%08x\n", ctx->fs);
    printk("  GS        = 0x%08x\n", ctx->gs);
    printk("  USER_ESP  = 0x%08x\n", ctx->useresp);
    printk("  EFLAGS    = 0x%08x\n", ctx->eflags);
}

void print_current_context_2(void)
{
    if (current_thread < 0 || current_thread >= thread_count)
        return;
    ...
    printk("Task %d CPU context:\n", current_thread);

    printk("CPU context address: 0x%08x\n", (unsigned long)ctx);
...
task_t* findthread(const char *name)
{
	...
	for(i=0;i<thread_count;i++)
	{
		if (thread[i].state != TASK_TERMINATE)
		{
			if (strcmp(thread[i].name, name) == 0)
			{
				task_t *t = &thread[i];
				return t;
			}
                  ...
                  unsigned long stack_size)
{
    ...
    if (stack_size == 0)
        ...
        words = stack_size / sizeof(unsigned long);

    if (words > STACK_WORDS)
        words = STACK_WORDS;

    if (words <= CONTEXT_WORDS + 4)
        return FALSE;

    t->kernel_cs = KERNEL_MODE_CODE_SEGMENT;
    t->kernel_ds = KERNEL_MODE_DATA_SEGMENT;
    ...
    frame = (context_t *)&t->stack[frame_index];
    ...
    frame->esp = (unsigned long)&t->stack[frame_index];
    ...
    frame->cs = current_cs;
    frame->eflags = (usermode) ? 0x200 : 0x0202;

    frame->useresp = 0;
    frame->ss = current_ds;

    t->stack_top = &t->stack[frame_index];
                 ...
                 int *new_thread_id)
{
	...
	if (strlen(name) >= 255) name_len = 255;
    ...
    t->quantum_left = 0;
    t->wake_tick = 0;
    t->thread_id = (unsigned long)new_id;
	...
	t->joiner_id = -1;
	t->joined = FALSE;
	if (flags & TASK_PROCESS) t->pid = thread_count;
	else t->pid = -1;
	...
	t->module = get_current_module();
	
    if (!inittaskframe(t, entry, param, (unsigned long)stack_size))
    {
        memset(t, 0, sizeof(task_t));
    ...
    prev = getprevthreadbyid(new_id, parent_id);
...
int k_createthread(task_t *handle_instance,
                 const char *name,
                 int attributes,
                 int stack_size,
                 unsigned long *start_address,
                 ...
                 int *new_thread_id)
{
	int r = kernel_createthread(handle_instance,
                 name,
                 attributes,
                 stack_size,
                 start_address,
...
int sys_createthread(createthread_args_t *uargs)
{
    createthread_args_t args;
...
void init_multitask(void)
{
    ...
    tlist = (int*)kmalloc(MAX_TASKS*sizeof(int));
    createthread(
        &idle_thread,
        "idle",
    	0,
...
void set_ps2_port2(unsigned char enabled)
{
	...
	unsigned char config = inb(0x60);  // Read current config
...
void sys_exit_handler(unsigned long exitcode)
{
	unsigned long _exit_code_value = exitcode;
	unsigned long *_exit_code = (unsigned long*)_exit_code_value;
	pop_module();
	kb_flush_require = 1;
	enable_interrupt();
	if (!scheduler_initialized) return;
	//int _pid = thread[current_thread].pid;
	task_terminate_with_result(thread[current_thread].thread_id, &_exit_code[0]);
}
...
{
    const elf_ehdr_t *eh = (const elf_ehdr_t *)image;
...
int elf_load(const void *image)
{
    ...
    for (unsigned short i = 0; i < eh->e_phnum; i++) 
    {
        ...
        void *dst = (void *)(unsigned long)ph->p_vaddr;
        const void *src = base + ph->p_offset;
        ...
        {
            memset((unsigned char *)dst + ph->p_filesz, 0, ph->p_memsz - ph->p_filesz);
        }
    }
...
int elf_jump(const void *image, void *param)
{
    const elf_ehdr_t *eh = (const elf_ehdr_t *)image;
    entry_fn entry = (entry_fn)(unsigned long)eh->e_entry;
    return entry(param);
}

int bin_jump(const void *image, void *param)
{
    entry_fn entry = (entry_fn)(unsigned long)image;
    return entry(param);
}
...
int execv_file(const char *path, char *const argv[])
{
	...
	int is_elf=0;
	int i=0,r=0;
	if (path == NULL) return WEXITSTATUS_NOT_FOUND;
	if (strlen(path) == 0) return WEXITSTATUS_NOT_FOUND;
	strcpy(fn, path);
	if (strcmp(strchr(strlwr(fn), '.'), ".elf") == 0)
	{
		if (fileexists(fn))
		{
			is_fn_exec = 1;
	...
	if (is_fn_exec)
	{		
		thread[current_thread].module = get_current_module();
		int fsz = getfilesize(fn);
		unsigned char *fdata = (unsigned char*)malloc(fsz);
		getfiledata(fn, fdata);
		
		if (!is_elf_type(fdata))
		{
			is_elf = 0;
		}

		if (thread[current_thread].args == NULL) return -1;
		const char **argp = (const char **)thread[current_thread].args;
		argparam_t *args = (argparam_t*)&argp[0];
			
		if (is_elf == 1)
		{	
			if (elf_load(fdata) == 0)
			{
				return elf_jump(fdata, args);
    		}
    	}
		else
		{
			if (is_bin == 1) return bin_jump(fdata, args);
			else
			{
				r = WEXITSTATUS_NOT_FOUND;
			}
		}
...
void sys_exit_group_handler(unsigned long status)
{
	unsigned long _status_code_value = status;
	unsigned long *_status_code = (unsigned long*)_status_code_value;
	pop_module();
	kb_flush_require = 1;
	enable_interrupt();
	if (!scheduler_initialized) return;
	task_terminate_with_result(thread[current_thread].thread_id, &_status_code[0]);
}
...
int sys_brk_handler(void *_addr)
{
	...
	task_t *current = &thread[current_thread];
	unsigned long addr = (unsigned long)_addr;
	if(addr == 0)
	{
		if (current->brk == 0) current->brk = (void*)sbrk(4096);
...
void syscall_handler(registers_t *registers)
{
	...
	switch(x)
	{
		...
		case 2:
		{
    		...
    		if (scheduler_initialized)
    		{
        		int pid = sys_fork_handler(registers);
        		thread[current_thread].pid = pid;
        		registers->eax = pid;
    		}
    		else
    		{
        		registers->eax = (unsigned long)-1;
    		}
		}
		break;
		case 3:
		{
			...
			if (arg1 == 0)
			{
				...
				//resetkeys();
				/*
				if (gets(buffer_ptr) != 0)
				{
					read_cnt = strlen(buffer_ptr);
				}
				*/	
				while (1)
				{
					...
					if (read_cnt < arg3)
					{
						if (key == '\b' && read_cnt>0) 
						{
							...
							putch(' ');
							putch(key);
							buffer_ptr[read_cnt] = 0;
							read_cnt--;
						}
						else
						{
							//if (key_shift && key_code==0) continue;
							if (key != '\b')
							{
								if (read_cnt < r_limit)
								{
									buffer_ptr[read_cnt] = key;
									read_cnt++;
									putch(key);
								}
							}
		...
		case 11:
		{
			...
			char _x_argv[256][256];
			void *_argv_ptr = (void*)arg2;
			int no_argv = 0;
			if (_argv_ptr != 0)
			{
				unsigned char *_argv_ptr_1 = (unsigned char*)_argv_ptr;
				if (_argv_ptr_1[0] != 0)
				{
					no_argv = 0;
					int ii = 0;
					while(ii < 256)
					{
						unsigned long offs = (ii*256);
						const char *s1 = (const char*)(_argv_ptr+offs);
						if (s1 != 0) 
						{
							if (s1[0] != 0) strcpy(_x_argv[ii], s1);
							else break;
						}
						else break;
						ii++;
					...
					_x_argv[ii][0] = '\0';
					registers->eax = execv_1((const char*)arg1, (char**)_x_argv);
				} else {
					no_argv = 1;
				}
			} else 
			...
			if (no_argv == 1)
			{
				registers->eax = execv_1((const char*)arg1, NULL);
			}
		}
		break;
		case 12:
		...
		case 45:
		{
			//registers->eax = (unsigned long)sys_brk_handler(registers->ebx);
			registers->eax = (unsigned long)sbrk(arg1);
			/*
			if (!thread[current_thread].brk) thread[current_thread].brk = (void*)(unsigned long)sbrk(arg1);
        	if (!registers->ebx) registers->ebx = (unsigned long)thread[current_thread].brk;
        	thread[current_thread].brk = (void*)(unsigned long)registers->ebx;
		...
		{
			enable_interrupt();
			registers->eax = (unsigned long)read_sector(arg2,(void*)arg3);
		}
		break;
		case 424:
		{
		...
		{
			//createthread();
			registers->eax = sys_createthread((createthread_args_t *)arg1);
		}
		break;
	};
}
...
int ehci_reset(void)
{
	...
	if (!(sts & EHCI_STS_HCHALTED)) return -1;
	cmd = ehci_op_regs->usb_cmd;
	cmd |= EHCI_CMD_RESET;
	ehci_op_regs->usb_cmd = cmd;
	for (j=0;j<1000;++j)
	...
	if (cmd & EHCI_CMD_RESET) return -2;								
...
int ehci_start(void)
{
	...
	unsigned long sts;
	cmd = ehci_op_regs->usb_cmd;
	cmd &= ~(EHCI_CMD_ASE | EHCI_CMD_PSE);
	cmd |= EHCI_CMD_RUN;
	ehci_op_regs->usb_cmd = cmd;
	for (j=0;j<1000;++j)
	{
    	sts = ehci_op_regs->usb_sts;
    	if (!(sts & EHCI_STS_HCHALTED)) return 0;
    	delay_ms(1);
	}
	return -1;
}
...
int ehci_reset_port(unsigned char p)
{
    ...
    if (v & EHCI_PORT_OWNER) return -2;
    if (!(v & EHCI_PORT_CCS)) return -3;
    if (!(v & EHCI_PORT_PED)) return -4;
...
void ehci_build_async(void)
{
    ...
    ehci_async_head.horizontal =
        ((unsigned long)&ehci_control_qh &
         EHCI_PTR_MASK) |
        EHCI_LINK_QH;
    ehci_async_head.ep_char = EHCI_QH_HEAD;
...
int wait_control_transfer(void)
{
    ...
    for (i = 0; i < 5000; ++i)
    {
        ...
        if (sts & EHCI_STS_HCHALTED) return -100;
        if (ehci_qtd_setup.token & EHCI_QTD_HALTED) return -1;
        if (ehci_qtd_data.token & EHCI_QTD_HALTED) return -2;
        if (ehci_qtd_status.token & EHCI_QTD_HALTED) return -3;
        if (ehci_qtd_setup.token & EHCI_QTD_XACTERR) return -4;
        if (ehci_qtd_data.token & EHCI_QTD_XACTERR) return -5;
        if (ehci_qtd_status.token & EHCI_QTD_XACTERR) return -6;
        if (ehci_qtd_setup.token & EHCI_QTD_BABBLE) return -7;
        if (ehci_qtd_data.token & EHCI_QTD_BABBLE) return -8;
        if (ehci_qtd_status.token & EHCI_QTD_BABBLE) return -9;
        if (ehci_qtd_setup.token & EHCI_QTD_DBE) return -10;
        if (ehci_qtd_data.token & EHCI_QTD_DBE) return -11;
        if (ehci_qtd_status.token & EHCI_QTD_DBE) return -12;
        if (!(ehci_qtd_status.token & EHCI_QTD_ACTIVE)) return 0;
...
int ehci_bulk_transfer(unsigned char address, unsigned char endpoint, int data_in, unsigned short max_packet, void *buffer, unsigned long length, unsigned char toggle)
{
    ...
    for (i = 0; i < 5000; ++i)
    {
        sts = ehci_op_regs->usb_sts;
        if (sts & EHCI_STS_HCHALTED) return -100;
        if (ehci_qtd_data.token & EHCI_QTD_HALTED) return -1;
        if (ehci_qtd_data.token & EHCI_QTD_XACTERR) return -5;
        if (ehci_qtd_data.token & EHCI_QTD_BABBLE) return -8;
        if (ehci_qtd_data.token & EHCI_QTD_DBE) return -11;
        if (!(ehci_qtd_data.token & EHCI_QTD_ACTIVE)) return 0;
        delay_ms(1);
    }
    return -50;
}
...
ehci_msc_t ehci_msc_list[MAX_USB_DEVICES];
int ehci_msc_list_count=0;
int has_ehci_msc = 0;
...
int ehci_read(int drive_id, void *buffer, unsigned long lba, unsigned short num_sectors)
{
    if (drive_id < 0 || drive_id >= ehci_msc_list_count) return 0;//-1;
    
    unsigned short sector_size = SECTORSIZE;
    unsigned char address = ehci_msc_list[drive_id].port + 1;
    unsigned long transfer_length = num_sectors * sector_size;    
    ehci_msc_cbw_t cbw __attribute__((aligned(32)));
    ehci_msc_csw_t csw __attribute__((aligned(32)));
...
void reloadsysteminfo(void)
{
	...
	if (info->physical_memory < ((unsigned long)512*1024*1024))
	{
		printk("Cannot start with less than 512 MB of memory.\n");
...
void loadsysteminfo(void)
{
	...
	if (info->physical_memory < ((unsigned long)256*1024*1024))
	{
		printk("Cannot start with less than 256 MB of memory.\n");
		panic((unsigned long)system_info);
	}
}

int last_scheduler_initialized = 0;

void kernelmode_preinit(void)
{
	last_scheduler_initialized = scheduler_initialized;
	scheduler_initialized = 0;
	enter_kernelmode = 1;
...
const char* ehci_get_usb_device_type(uint8_t class_code, uint8_t subclass_code, uint8_t protocol_code)
{
...
void dump_hex(const void *data, size_t size) {
    ...
    for (i = 0; i < size; i += 16) {
		...
		for (int j = 0; j < 16; j++) {
			if (i + j < size)
				printk("%c", isprint(buffer[i + j]) ? buffer[i + j] : '.');
			else
				printk(" ");
		}
        printk("\n");
...
{	
	...
	else
	{
		...
		mouse_x = (mouse_screen_width/2)-1;
		mouse_y = (mouse_screen_height/2)-1;
		mouse_b = 0;
		mouse_w = 0;
		memset(&mouse_state, 0, sizeof(mouse_state_t));
		disable_interrupt();
...
void print_string(int x, int y, const char *s, char color) {
	if ((s == 0) || (s == NULL)) return;
    char *ss = (char*)s;
    int xx = x;
    print_char(xx, y, ss[0], color);
    while(*ss != 0 && xx < 80) {
    	if (*ss >= 0x20) {
    		print_char(xx, y, *ss, color);
    		xx++;
    	}
    	ss++;
    }
...
void print_number(int x, int y, int n, char color)
{
    char s[12];
    int i = 0;
    unsigned int value;
    ...
    *digits = '\0';
    ...
    print_string(x, y, s, color);
}

void print_hex_1(int x, int y, unsigned long n, int digits, char color)
{
    char s[11];
...
void print_number_field(int x, int y, const char *s, int n, char color)
{
	int xx = strlen(s);
	print_string(x, y, s, color);	
	print_number(x+xx, y, n, color);
}

void print_hex_field(int x, int y, const char *s, int n, int d, char color)
{
	int xx = strlen(s);
	print_string(x, y, s, color);
    print_hex_1(x+xx, y, n, d, color);
}




void printContext_1(void)
{
	task_t *t = (task_t*)&thread[current_thread];
	
	print_number_field(0, 12, "Task Thread Count: ", thread_count, 0x0A);
	print_hex_field(0, 13, "Current ESP: ", (unsigned long)t->esp, 8, 0x0A);
	print_hex_field(0, 14, "CPU context address: ", (unsigned long)&t->context, 8, 0x0A);
	print_hex_field(0, 15, "  EAX     = ", t->context.eax, 8, 0x0A);
	print_hex_field(0, 16, "  EBX     = ", t->context.ebx, 8, 0x0A);
	print_hex_field(0, 17, "  ECX     = ", t->context.ecx, 8, 0x0A);
	print_hex_field(0, 18, "  EDX     = ", t->context.edx, 8, 0x0A);
	print_hex_field(0, 19, "  ESI     = ", t->context.esi, 8, 0x0A);
	print_hex_field(0, 20, "  EDI     = ", t->context.edi, 8, 0x0A);
	print_hex_field(0, 21, "  EBP     = ", t->context.ebp, 8, 0x0A);
	print_hex_field(0, 22, "  ESP     = ", t->context.esp, 8, 0x0A);
	print_hex_field(24, 15, "  CS     = ", t->context.cs, 8, 0x0A);
	print_hex_field(24, 16, "  DS     = ", t->context.ds, 8, 0x0A);
	print_hex_field(24, 17, "  ES     = ", t->context.es, 8, 0x0A);
	print_hex_field(24, 18, "  FS     = ", t->context.fs, 8, 0x0A);
	print_hex_field(24, 19, "  GS     = ", t->context.gs, 8, 0x0A);
	print_hex_field(24, 20, "  EIP    = ", t->context.eip, 8, 0x0A);
	print_hex_field(24, 21, "  EFLAGS = ", t->context.eflags, 8, 0x0A);
}

void *taskForkTest(void *param);

void taskA_1(void *param)
{
    while(1) 
    {
        print_number(0, 6, counting1, 0x0E);
        for(volatile int i=0; i<100000; i++);
        counting1++;
    }
}

void taskB1(void *param)
{
    while(1) {        
        print_number(12, 6, counting2, 0x0E);        
        for(volatile int i=0; i<100000; i++);
        counting2++;
    }
}
void taskB_1(void *param)
{
    int count = 0;    
    while (1) {
        print_number(12, 6, counting2, 0x0E);        
        ...
        counting2++;
        /*
        if (thread[current_thread].parent != NULL) print_string(60, 20, thread[current_thread].parent->name, 0x0A);
        if (thread[current_thread].prev != NULL) print_string(60, 21, thread[current_thread].prev->name, 0x0A);
        if (thread[current_thread].next != NULL) print_string(60, 22, thread[current_thread].next->name, 0x0A);
        */
        task_t *f = findthread("taskSubNew2");
        if (f != NULL)
        {
        	print_string(60, 15, f->parent->name, 0x0A);
        }
        //if (count < 10) count++;
        //if(count == 10) task_terminate(current_thread);
        //if (thread[current_thread].parent != NULL) print_string(60, 20, thread[current_thread].parent->name, 0x0A);
        //if (thread[current_thread].prev != NULL) print_string(60, 21, thread[current_thread].prev->name, 0x0A);
        //if (thread[current_thread].next != NULL) print_string(60, 22, thread[current_thread].next->name, 0x0A);
    }
...
void *taskSubNew(void *param)
{
	const char *value = (const char*)param;
	print_string(60,17,"SUB1",0x0A);
	if (param != NULL) print_string(60,18,value,0x0A);
	return "Result SUB1";
}

void taskSubNew2(void *param)
{
	const int *value = (const int*)param;
	print_string(67,17,"SUB2",0x0A);
	if (param != NULL) print_number(67,18,*value,0x0A);
    if (thread[current_thread].parent != NULL) print_string(60, 20, thread[current_thread].parent->name, 0x0A);
    if (thread[current_thread].prev != NULL) print_string(60, 21, thread[current_thread].prev->name, 0x0A);
    if (thread[current_thread].next != NULL) print_string(60, 22, thread[current_thread].next->name, 0x0A);
	task_terminate(current_thread);
}

void taskSubNew3(void *param)
{
	const vector3i_t *value = (const vector3i_t*)param;
	print_string(75,17,"SUB3",0x0A);
	if (param != NULL) 
	{
		print_number_field(75,18,"X:",value->x,0x0A);
		print_number_field(75,19,"Y:",value->y,0x0A);
		print_number_field(75,20,"Z:",value->z,0x0A);
	}
	task_terminate(current_thread);
}

void taskNew(void *param)
{
    int sub1_id;
    void *result1;

	int v = 2026;
	vector3i_t v1 = {x: 2, y: 5, z: 8};
    createthread(
        0,
        "taskSubNew",
    	0,
	...
	print_string(60,19,"ABC",0x0A);
    if (pthread_join(sub1_id, &result1) == PTHREAD_JOIN_SUCCESS)
    {
    	if (result1 != NULL)
    		print_string(60, 23, (const char *)result1, 0x0A);
    }
	task_terminate(current_thread);
}

void taskNew2Sub1(void *param)
{
	print_string(60,8,"TEST123",0x0A);
}
...
void taskNew2(void)
{
	...
	print_string(60,9,"NEWTEXT1",0x0A);
//	task_terminate(current_thread);
	sleep(4);
	print_string(60,9,"TEXTTEST",0x0A);
	task_ready(new2sub1_id);
}

void taskC_1(void *param)
{
    int count = 0;
    //int task_fork_2_id;
    
    task_block(findthread("taskB_1")->thread_id);
    ...
    set_task_priority(task_fork_2_id, PRIORITY_NORMAL);
    */
    
    while(1) {
    	if (counting3 == 7) task_ready(findthread("taskB_1")->thread_id);
        print_number(24, 6, counting3, 0x0E);
        sleep(1);
        //for(volatile int i=0; i<100000; i++);        
        counting3++;
        //if (count < 11) count++;
        //if(count == 11) task_terminate(current_thread);
    }
}

void taskD_1(void *param) 
{
    int count = 0;
    while(1) {
        print_number(36, 6, counting4, 0x0E);
        //sleep(1);
        for(volatile int i=0; i<100000; i++);        
        counting4++;
        if (count < 1001) count++;
        if(count == 1001) task_terminate(current_thread);
    }
}
...
void multitask_test(void)
{
    ...
    task_t task_a_thread;
    task_t task_b_thread;
    task_t task_c_thread;
    task_t task_d_thread;
    hidecursor();
    clrscr();
    resetkeys();
    counting1 = 0;
    ...
    set_task_priority(task_a_id, PRIORITY_HIGH);
    set_task_priority(task_b_id, PRIORITY_NORMAL);
    set_task_priority(task_c_id, PRIORITY_LOW);
    set_task_priority(task_d_id, PRIORITY_NORMAL);        
    set_task_priority(task_fork_id, PRIORITY_NORMAL);        
    
    while (q == 0)
    {
        print_char(0, 5, 'A', 0x0A);
        print_char(12, 5, 'B', 0x0C);
        print_char(24, 5, 'C', 0x0B);
        print_char(36, 5, 'D', 0x09);

        for (volatile int i = 0; i < 100000; i++);

		printContext_1();
		for(int k=0;k<256;k++) if (kbhit(k)) q = 1;
    }
    
    task_terminate(findthread("taskA_1")->thread_id);
    task_terminate(findthread("taskB_1")->thread_id);
    task_terminate(findthread("taskC_1")->thread_id);
    task_terminate(findthread("taskD_1")->thread_id);
    task_terminate(findthread("taskNew")->thread_id);
    task_terminate(findthread("taskSubNew")->thread_id);
    task_terminate(findthread("taskSubNew2")->thread_id);
    task_terminate(findthread("taskSubNew3")->thread_id);
    task_terminate(findthread("taskNew2")->thread_id);
    task_terminate(findthread("taskNew2Sub1")->thread_id);
    task_terminate(findthread("taskForkTest")->thread_id);
...
int task_new_test_empty_count = 0;
...
static inline void load_entry(void* entry, uint32_t cs, uint32_t ds, uint32_t flags, uint32_t stack)
{
	__asm__ volatile (
    	"ljmp $0x08, $1f\n\t"
        "1:"
...
int main(void)
{
	...
	if (init_ehci_msc())
	{
		storage_drive_controller = STORAGE_CONTROLLER_EHCI;
	}
	else
	{
		if (init_ahci())
	...
	printk("Build number: 1000.12, rev: 2026.09\n");
	printk("\n");
	...
	if ((enum_loaded) && (total_enum > 0))
	{
		if (has_enum(SYSTEM_MULTI_THREAD_SUPPORT))
		{
			multitask_enabled = 1;
		}
		else
	...
	while(1)
	{
		...
		if (gets(sh) != 0)
		{
			...
			if (argc > 0)
			{
				...
				if (strcmp(argv[0], "int2b") == 0)
				{
					__asm__ __volatile__("int $0x2b");
				}
				else
				...
				if (strcmp(argv[0], "kbtest") == 0)
				{
					unsigned char key_ch = 0;
					while ((key_ch = getch_stdin()) != '\n')
					{
						printk("0x%02X\n", key_ch);
					}
				}
				else
				if (strcmp(argv[0], "killthread") == 0)
				{
					if (argc > 1)
					{
						task_terminate(atol(argv[1]));
					}
				}
				else
				if (strcmp(argv[0], "createthread") == 0)
				{
					char tmpname[256];
					sprintk(tmpname, "task_new_%02d\0", task_new_test_empty_count+1);
					createthread(
        						0,
        						tmpname,
    							0,
				...
				if (strcmp(argv[0], "threads") == 0)
				{
					...
					else
					{
						int show_thread_ids;
						int tlist_tmp_cnt=0;
						unsigned long *tlist_tmp = (unsigned long *)malloc(65536);
						if (argc > 1)
						{
							if (strcmp(argv[1], "-i") == 0) show_thread_ids = 1;
							else show_thread_ids = 0;
						} else show_thread_ids = 0;					
						get_thread_list(tlist_tmp, &tlist_tmp_cnt);
						for(int t_i=0;t_i<tlist_tmp_cnt;t_i++)
						{
							int thread_id_l = tlist_tmp[t_i];
							if (show_thread_ids) printk("%d: ", thread[thread_id_l].thread_id);
							printk("%s\n", thread[thread_id_l].name);
						}
						free(tlist_tmp);
					}
				}
				...
				if (strcmp(argv[0], "thread") == 0)
				{
					...
					else
					{
						...
						if (argc > 1)
						{
							selected_thread = atol(argv[1]);
						}
						else
						{
							selected_thread = current_thread;
						}
						task_t *sel_thread = &thread[selected_thread];
						printk("Thread: %d\n", selected_thread);
						printk("  Name: %s\n", sel_thread->name);
						printk("  State: %s\n", task_state_str[sel_thread->state]);
						printk("  Priority: %s\n", priority_str[sel_thread->priority]);
					}
				}
				else 
				if (strcmp(argv[0], "prevthread") == 0)
				{
					if (scheduler_initialized == 0)
					{
						printk("Has not multitasking enabled yet.\n");
					...
					else
					{
						...
						task_t *prev_thread = thread[selected_thread].prev;
						if (prev_thread != NULL)
						{
							printk("Previous Thread: %d\n", prev_thread->thread_id);
							printk("  Name: %s\n", prev_thread->name);
							printk("  State: %s\n", task_state_str[prev_thread->state]);
							printk("  Priority: %s\n", priority_str[prev_thread->priority]);
						}
					}
				}
				else 
				if (strcmp(argv[0], "nextthread") == 0)
				{
					if (scheduler_initialized == 0)
					{
						printk("Has not multitasking enabled yet.\n");
					...
					else
					{
						...
						task_t *next_thread = thread[selected_thread].next;					
						if (next_thread != NULL)
						{
							printk("Next Thread: %d\n", next_thread->thread_id);
							printk("  Name: %s\n", next_thread->name);
							printk("  State: %s\n", task_state_str[next_thread->state]);
							printk("  Priority: %s\n", priority_str[next_thread->priority]);
						}
					}
				}
				else 
				...
				if (strcmp(argv[0], "itest") == 0)
				{
					test_irq_safe_critical_section();
				}
				else 				

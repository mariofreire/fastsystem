...
unsigned char pci_initialized ENHANCED_DATA_SECTION = 0;
...
ENHANCED_CODE_SECTION void pci_write_byte(unsigned char bus, unsigned char slot, unsigned char func, unsigned char offset, unsigned char value)
{
	unsigned long addr = pci_config_address(bus, slot, func, offset);
	outl(0x0CF8, (unsigned long)addr);
...
ENHANCED_CODE_SECTION void pci_write_word(unsigned char bus, unsigned char slot, unsigned char func, unsigned char offset, unsigned short value)
{
	unsigned long addr = pci_config_address(bus, slot, func, offset);
	outl(0x0CF8, (unsigned long)addr);
...
ENHANCED_CODE_SECTION void pci_write_long(unsigned char bus, unsigned char slot, unsigned char func, unsigned char offset, unsigned long value)
{
	unsigned long addr = pci_config_address(bus, slot, func, offset);
	outl(0x0CF8, (unsigned long)addr);
	outl(0x0CFC, value);
...
ENHANCED_CODE_SECTION int init_pci(void)
{

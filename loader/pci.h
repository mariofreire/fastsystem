...
extern unsigned char pci_initialized ENHANCED_DATA_SECTION;
...
extern void pci_write_byte(unsigned char bus, unsigned char slot, unsigned char func, unsigned char offset, unsigned char value) ENHANCED_CODE_SECTION;
extern void pci_write_word(unsigned char bus, unsigned char slot, unsigned char func, unsigned char offset, unsigned short value) ENHANCED_CODE_SECTION;
extern void pci_write_long(unsigned char bus, unsigned char slot, unsigned char func, unsigned char offset, unsigned long value) ENHANCED_CODE_SECTION;

...
extern ahci_hba_port_t *ahci_port ENHANCED_DATA_SECTION;
extern ahci_hba_memory_t *ahci_hba ENHANCED_DATA_SECTION;
extern unsigned char *ahci_ptr ENHANCED_DATA_SECTION;
extern ahci_t *ahci ENHANCED_DATA_SECTION;
...
extern int check_ahci_port(int portno) ENHANCED_CODE_SECTION;
extern int check_ahci_ports(unsigned char *ports, unsigned char *portmax) ENHANCED_CODE_SECTION;
...
extern ahci_hba_memory_t *get_ahci_hba_memory(void) ENHANCED_CODE_SECTION;
extern void *get_ahci_hba_ptr(void) ENHANCED_CODE_SECTION;
extern unsigned long get_ahci_hba(void) ENHANCED_CODE_SECTION;

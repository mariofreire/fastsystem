...
ahci_hba_port_t *ahci_hba_port ENHANCED_DATA_SECTION;
ahci_hba_memory_t *ahci_hba ENHANCED_DATA_SECTION;
ahci_port_t ahci_port[32] ENHANCED_DATA_SECTION;
unsigned char ahci_list_count ENHANCED_DATA_SECTION = 0;
unsigned char ahci_list[32] ENHANCED_DATA_SECTION;
...
ENHANCED_CODE_SECTION int check_ahci_ports(void)
{
